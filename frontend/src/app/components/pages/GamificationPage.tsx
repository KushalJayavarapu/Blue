...
const kanbanCols = [
  ...
  { id: 'review',    label: 'Under Review', color: 'text-rose-400',  border: 'border-rose-500/20',  bg: 'bg-rose-500/5'  },
            ...
            <tbody>
              {[
                ...
                <tr key={i} className="border-b border-[#1a2035] hover:bg-[#111827] transition-colors">
                  ...
                  <td className="px-5 py-3.5">
                    <span className={`text-[11px] px-2 py-0.5 rounded-full border ${row.done ? 'text-blue-400 bg-blue-500/10 border-blue-500/20' : 'text-rose-400 bg-rose-500/10 border-rose-500/20'}`}>
